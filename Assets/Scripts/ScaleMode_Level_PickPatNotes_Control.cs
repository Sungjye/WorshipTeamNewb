//====================================================================================
// 주님, 이렇게 차근차근 할 수 있게 해 주셔서 감사합니다!
//
// 패턴 스케일(단음) 브릭 여러개 모드.
// 
...
//
// 2023.07.24. sjjo. Copied from ScaleMode_Level_PickNote_Control
//
//====================================================================================
...
public class ScaleMode_Level_PickPatNotes_Control : MonoBehaviour
{
    ...
    private void OnMouseDown()
    {
       ...
       // sCodeMode_Tapped_Keypad_inTermsOfTheSelectedKey
        ...
        this.gmobjPlayManager.GetComponent<ScaleMode_Level_PickPatNotes_PlayManager>().CheckIfInputIsCorrect(this.name);
