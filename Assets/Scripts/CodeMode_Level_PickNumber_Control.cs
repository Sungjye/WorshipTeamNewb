...
/*
        ...
        instCodeBrick.transform.GetChild(0).gameObject.GetComponent<TextMeshPro>().text 
                    = GameManager.Instance.dicCode_byKeyAndDoNum[GameManager.Instance.eSelectedKey][(eDO_NUMBER)System.Enum.Parse(typeof(eDO_NUMBER), this.name)];
                    //= GameManager.Instance.dicCode_byKeyAndDoNum[eKEYCODES.C][eDO_NUMBER._1do];
*/
