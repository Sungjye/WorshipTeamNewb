//====================================================================================
//
// 주님, 찬찬히 진행할 수 있게 해 주셔서 감사합니다!
// 
// 키 알아 맞추기, 코드 모드를 하는 레벨에서,
...
//
// 2023.08.07. sjjo. Copied from ScaleMode_Level_RecogKeys_Control
//====================================================================================
...
public class CodeMode_Level_RecogKeys_Control : MonoBehaviour
{
    ...
    private void OnMouseDown()
    {
       ...
       // sCodeMode_Tapped_Keypad_inTermsOfTheSelectedKey
        ...
        this.gmobjPlayManager.GetComponent<CodeMode_Level_RecogKeys_PlayManager>().CheckIfInputIsCorrect(this.name);
